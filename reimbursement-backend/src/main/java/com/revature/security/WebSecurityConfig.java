...
public class WebSecurityConfig {
    ...
    @Autowired
    public WebSecurityConfig(EmployeeDAO employeeDAO, JwtTokenFilter jwtTokenFilter, AuthenticationManagerBuilder authenticationManagerBuilder) {
    ...
    //We use the employeeDAO to find a user by username, or throw an exception
    @Autowired
